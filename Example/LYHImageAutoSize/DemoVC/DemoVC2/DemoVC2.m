...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
   NewsModel *model = self.dataArray[indexPath.row];
     ...
     */
    CGFloat imageHeight = [LYHImageAutoSize imageHeightForURL:[NSURL URLWithString:model.top_image] layoutWidth:[UIScreen mainScreen].bounds.size.width-16 estimateHeight:200];
