...
@interface LYHImageAutoSizeCache()

@property(nonatomic,strong)NSCache * memCache;
@property(nonnull,strong)NSFileManager *fileManager;

@end
@implementation LYHImageAutoSizeCache

+(LYHImageAutoSizeCache *)shardCache{
    static LYHImageAutoSizeCache *instance = nil;
    static dispatch_once_t oneToken;
    dispatch_once(&oneToken,^{
        instance = [[LYHImageAutoSizeCache alloc] init];
    });
    return instance;
}
...
#pragma mark - LYHImageAutoSizeCache (private)
...
-(NSString *)baseCacheDirectory{
    ...
    NSString *path = [pathOfLibrary stringByAppendingPathComponent:@"LYHImageAutoSizeCache"];
    return path;
